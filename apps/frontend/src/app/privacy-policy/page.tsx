...
export default function Page() {
    return (
        <div>
                ...
                <div className="flex">
                    ...
                    <div className="flex-1">
                        <p className="px-2 text-base text-blue-700">
                            sheet.stream&apos;s use and transfer to any other app of information received from Google
                            APIs adheres to{" "}
                            <a
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Grey Apps Group Ltd., 20-22
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to sheet.stream, accessible from{" "}
                        <a href="https://sheet.stream">https://sheet.stream</a>
                    </p>
                </li>
                <li>
                    <p>
            ...
            <ul>
                <li>By email: hello@pocketarc.com</li>
            </ul>
        </div>
    );
}
