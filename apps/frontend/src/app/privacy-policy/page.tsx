            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        Agreement) refers to Grey Apps Group Ltd., 20-22 Wenlock Road, London, England, N1 7GU.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to sheet.stream, accessible from <a href="https://sheet.stream">https://sheet.stream</a>
                    </p>
                </li>
                <li>
                    <p>
